...
//#endregion
//#region src/ui/tabItem.tsx
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var Button = ({ variant, onClick, children }) => {
...
var TabItem = ({ tab, onClick, button }) => {
...
var CopyToClipboard = ({ value }) => {
	const [icon, setIcon] = import_react.useState("copy");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		children: icon === "check" ? check() : icon === "cross" ? cross() : copy()
	});
};
//#endregion
//#region src/ui/authToken.tsx
/**
* Copyright (c) Microsoft Corporation.
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* limitations under the License.
*/
var AuthTokenSection = ({}) => {
	const [authToken, setAuthToken] = (0, import_react.useState)(getOrCreateAuthToken);
	const onRegenerateToken = (0, import_react.useCallback)(() => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "auth-token-description",
			children: "Set this environment variable to bypass the connection dialog:"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "auth-token-container",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", {
					className: "auth-token-code",
					children: authTokenCode(authToken)
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CopyToClipboard, { value: authTokenCode(authToken) })
			]
		})]
	});
};
...
//#endregion
export { require_jsx_runtime as a, __toESM as c, TabItem as i, getOrCreateAuthToken as n, require_client as o, Button as r, require_react as s, AuthTokenSection as t };
